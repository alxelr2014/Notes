...
For Fr\'{e}chet derivative, \(\DiffOperator f: U \to \func{\CalL}{V,W}\) if differentiable at \(x\), then \(f\) is twice differentiable and
\begin{equation*}
    \DiffOperator^2 \func{f}{x} = \operatorFunc{\func{\DiffOperator}{\DiffOperator f}}{x} : U \to \func{\CalL}{V,W}
\end{equation*}
therefore
\begin{equation*}
    \DiffOperator^2 f :  U \to \func{\CalL}{V,\CalL{V,W}}
\end{equation*}
...
\end{equation*}
where \(\diffOperator^2 = \func{T}{\DiffOperator^2}\) as defined in \Cref{pr:nLinearIsmorphicLinear}. With this definition, the higher order derivatives \(n \geq 2\)
\begin{equation*}
    \diffOperator^n : U \to \func{\CalL}{V^n, W}
\end{equation*}
