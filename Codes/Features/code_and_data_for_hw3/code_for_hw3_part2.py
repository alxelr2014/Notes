...
def get_classification_accuracy(data, labels):
    ...
    """
    return xval_learning_alg(perceptron, data, labels, 10, params={'T': 50})
...
def load_mnist_data(labels):
    ...
    for label in labels:
        images = load_mnist_single("C:/Users/emadz/Desktop/School/Books/Summer II/Machine "
                                   + "Learning/Workspace/Codes/Features/code_and_data_for_hw3/"
                                   + "mnist/mnist_train{}.png".format(label))
